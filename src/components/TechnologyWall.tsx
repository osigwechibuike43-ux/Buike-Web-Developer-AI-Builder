...
export function TechnologyWall() {
  return (
    <section className="py-24 relative border-t border-white/10 bg-black text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
          {TECH_WALL.map((tech, idx) => (
            <div
              key={idx}
              className="p-5 bg-[#050505] border border-white/10 hover:border-white/30 transition-all duration-300 flex flex-col items-center justify-center text-center space-y-3 group cursor-default"
            >
